...
This project includes automated code quality checks that run automatically when you push code to GitHub.
...
- **Build Check**: Verifies the project can build successfully
